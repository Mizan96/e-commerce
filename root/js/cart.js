        ...
        $.ajax({
          ...
          success: function(data){
            ...
            if (currentPath.indexOf("details") == -1) {
              if (data.added){
                submitSpan.html('<button type="submit"> <p class="small" style="color: red"><i class="fas fa-cart-arrow-down"></i> Remove </p></button>')
              } else {
                    submitSpan.html('<button type="submit"><p class="small" style="color: green"><i class="fas fa-cart-plus text-left"></i> Add to cart </p></button>')
               }
            }
            else{
              if (data.added){
                ...
                submitSpan.html("<button type='submit'  class='btn btn-warning btn-block'><i class='fas fa-cart-plus add-to-cart-button'></i>Add to cart</button>")
               }
            }
