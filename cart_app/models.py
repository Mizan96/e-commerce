...
from products_app.models import IndividualProduct
from cart_app.signals import calculate_cart_total
...
class CartManager(models.Manager):
    ...
    def cart_total(self, request):
        ...
        cart_product_obj = IndividualProduct.objects.get(id=cart_product_id)
...
class Cart(models.Model):
    ...
    products    = models.ManyToManyField(IndividualProduct, through='CartAmount',blank=True)
